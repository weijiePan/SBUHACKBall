...
export function UploadFileButton() {
    return (
        ...
        //     <input type="file" accept="video/*" name="" id="" />
            <button className="h-10 flex items-center flex-row px-2 gap-2 py-1 bg-foreground text-background rounded w-full">
                <svg
                ...
                <p className="max-w-md text-md font-medium leading-8 text-text truncate"> Upload a video for analysis
                </p>
            </button>
        // </form>
    )
...
export default function Header() {
    return (
        <nav className="pl-2 h-14 w-full pr-2 bg-background-tone1 flex flex-row items-center gap-2">
            <UploadFileButton />

            <div className="flex gap-2 flex-row">
                <div className="border flex justify-center items-center w-10 h-10">
                    <svg
                        className="text-text w-6 h-6"
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
