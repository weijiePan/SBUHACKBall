...
export default function Header() {
    return (
        <div className="">
            <nav className="h-14 w-full pl-48 pr-2 bg-background-tone1 flex flex-row items-center gap-2">
                <div className="h-10 flex flex-row px-2 py-1 bg-primary text-background rounded w-full">
